  ...
  public: {
    Tables: {
      ...
      billing_subscriptions: Table<{
        id: string;
        user_id: string;
        plan_id: "free" | "pro" | "executive";
        status: "trialing" | "active" | "past_due" | "cancelled" | "manual_review";
      ...
      billing_usage_ledger: Table<{
        ...
        unit_cny: number;
        amount_cny: number;
        status: "included" | "billable" | "blocked" | "void";
        source: string;
      ...
      billing_invoice_requests: Table<{
        id: string;
        user_id: string;
        plan_id: "free" | "pro" | "executive" | null;
        amount_cny: number;
        buyer_title: string;
        tax_id: string | null;
        email: string | null;
      ...
      cps_finance_approvals: Table<{
        id: string;
        user_id: string;
        provider: "jd" | "taobao" | "meituan" | "ctrip" | "tongcheng";
        external_order_id: string;
        settlement_period: string | null;
        net_amount_cny: number;
        commission_cny: number;
        risk_flags: string[];
        required_evidence: string[];
        status: "pending_finance" | "approved" | "held" | "rejected" | "paid";
        finance_note: string;
        metadata: Json;
        decided_at: string | null;
        created_at: string;
      }>;
      ops_alert_events: Table<{
        id: string;
        user_id: string;
        alert_id: string | null;
        action: "created" | "acknowledged" | "resolved" | "reopened" | "assigned";
        actor_role: string;
        note: string | null;
        metadata: Json;
        created_at: string;
